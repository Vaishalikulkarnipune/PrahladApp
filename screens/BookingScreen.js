...
const styles = StyleSheet.create({
    ...
    bookingCard: {backgroundColor: '#fff', borderRadius: 8, padding: 16, marginBottom: 10, shadowColor: '#000', shadowOpacity: 0.1, shadowOffset: {width: 0, height: 2}, shadowRadius: 5, elevation: 3, borderLeftWidth: 5, borderColor: '#ff4500'},
    bookingDetails: {flexDirection: 'row', justifyContent: 'space-between', marginBottom :' 5'},
    ...
    noBookingsText: {fontSize: 10, textAlign: 'center', marginTop: 20, color: '#999'}
})
