...
const RegisterScreen = ({ navigation }) => {
    ...
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <TextInput style={styles.input} placeholder="Mobile Number" value={mobileNumber} onChangeText={setMobileNumber} keyboardType="numeric" />
            <TextInput style={styles.input} placeholder="Alternate Mobile Number" value={altMobileNumber} onChangeText={setAltMobileNumber} keyboardType="numeric" />
            <TextInput style={styles.input} placeholder="Flat No." value={flatNo} onChangeText={setFlatNo} />
            <TextInput style={styles.input} placeholder="Full Address" value={fullAddress} onChangeText={setFullAddress} />
            ...
            <View style={styles.pickerContainer}>
                ...
                <Picker selectedValue={anugrahit} style={styles.picker} onValueChange={(itemValue) => setAnugrahit(itemValue)}>
...
const styles = StyleSheet.create({
    ...
    input: { borderWidth: 1, marginVertical: 12, paddingHorizontal: 8, borderRadius: 4, width: '100%', height: 40, borderColor: '#cccccc' },
    pickerContainer: { width: '100%', marginVertical: 10 },
    pickerLabel: { fontSize: 16, fontWeight: 'bold', marginBottom: 5, color: '#ff4500' },
